...
public class Customer extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            st.executeUpdate("INSERT INTO `customer` (c_name,c_mobile,c_address) VALUES ('" + name + "','" + mobile + "','" + address + "')");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            while (rs.next()) {
                ...
                c_number.setText(rs.getString("c_mobile"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Statement s = db.mycon().createStatement();
            s.executeUpdate(" UPDATE customer SET c_name ='" + name + "' ,c_mobile ='" + number + "',c_address='" + address + "' WHERE c_id = '" + search + "' ");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Statement s = db.mycon().createStatement();
            s.executeUpdate(" DELETE  from customer WHERE c_id = '" + search + "' ");
